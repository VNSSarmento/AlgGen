            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <label class="relative flex items-center p-4 bg-gray-750 border-2 border-gray-700 rounded-xl cursor-pointer hover:border-indigo-500 hover:bg-gray-700 transition has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-900/30">
                                    <input name="sub" type="checkbox" class="sr-only peer">
                                    <div class="flex items-center w-full">
                ...
                <div class="bg-gray-750 rounded-xl p-6 border border-gray-700">
                    ...
                    <div class=" flex flex-col items-center gap-10 py-1 text-center">
                        ...
                        <div class="mt-2 w-full bg-gray-800 rounded-lg border border-gray-700 max-h-[300px] overflow-y-auto">
                        ...
                        <div class="flex gap-3 mt-2">
                            ...
                            <a href="{{ route('export') }}" class="flex-1 bg-blue-700 text-white font-medium px-10 py-4 rounded-lg flex items-center justify-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                </svg>
                                <span class="text-sm">Download texto</span>
                            </a>
                            
                            <a href="{{ route('exportPDF') }}" class="flex-1 bg-blue-700 text-white font-medium px-10 py-4 rounded-lg flex items-center justify-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                </svg>
