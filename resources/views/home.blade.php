                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-white mb-3">
                                ...
                                <span class="text-blue-400 font-bold ml-2 text-lg">10</span>
                            </label>
                            <input type="range" min="1" max="100" value="10" class="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer accent-blue-600">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <button class="px-4 py-3 bg-green-900/30 border-2 border-green-600 text-green-400 rounded-lg font-medium hover:bg-green-900/50 transition">
                                    Fácil
                                </button>
                                <button class="px-4 py-3 bg-gray-750 border-2 border-gray-700 text-gray-300 rounded-lg font-medium hover:bg-gray-700 transition">
                                    Médio
                                </button>
                                <button class="px-4 py-3 bg-gray-750 border-2 border-gray-700 text-gray-300 rounded-lg font-medium hover:bg-gray-700 transition">
                                    Difícil
                            ...
                            <p class="text-xs text-gray-500 mt-2">Fácil: números de 1 a 10</p>
                        </div>

                        <!-- Generate Button -->
                        <button class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl transition duration-200 shadow-lg hover:shadow-blue-900/50 flex items-center justify-center space-x-2">
